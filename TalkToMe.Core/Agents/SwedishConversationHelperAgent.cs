...
public class SwedishConversationHelperAgent : BaseWithMemoryAgent
{
    public SwedishConversationHelperAgent(IAIProviderFactory aiProviderFactory, IConversationManager conversationManager) :
