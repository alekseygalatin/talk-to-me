...
public class EnglishConversationHelperAgent : BaseWithMemoryAgent
{
    public EnglishConversationHelperAgent(IAIProviderFactory aiProviderFactory, IConversationManager conversationManager) :
        base(aiProviderFactory, conversationManager, AIProvider.AmazonBedrock, BedrockAIModelNames.AWS_Nova_Pro)
    {
    ...
    protected override string AgentId => "2";
